        ...
        {(() => {
          ...
          return (
            ...
            >
              ...
              {data.length > 0 ? (
                <div className="grid auto-cols-[280px] grid-flow-col grid-cols-[repeat(auto-fill,280px)] gap-4 overflow-x-auto p-4">
                  {data.map((invoice) => (
                    <I18NProvider
                      key={invoice.id}
                      value={{
