...
export function Navbar() {
  ...
  return (
    <Disclosure
      as="nav"
      className="sticky top-0 z-10 bg-gray-800/90 shadow backdrop-blur dark:bg-zinc-950/95 print:hidden"
    >
        ...
        <div className="relative flex h-16 items-center justify-between">
          <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
            <Disclosure.Button className="relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
              ...
              <XMarkIcon className="h-6 w-6 ui-open:block ui-not-open:hidden" aria-hidden="true" />
              <Bars3Icon className="h-6 w-6 ui-open:hidden ui-not-open:block" aria-hidden="true" />
            </Disclosure.Button>
          </div>
